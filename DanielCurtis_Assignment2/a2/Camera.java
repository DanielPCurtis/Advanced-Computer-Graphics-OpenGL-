...
public class Camera {
	...
	public Camera(float u, float v, float n)	{
		reset();
		this.uVector = u;  // current xLocation
		this.vVector = v;  // current yLocation
		this.nVector = n;  // current zLocation  		Pw - world space location
		camMat = new Matrix4f();
		Display();
	}
	...
	void rotateX()
	{
		rotX = new Matrix4f(	1, 0, 0, uVector,
								0, 1, 0, vVector,
								0, 0, 1, nVector,
								0, 0, 0, 1
							);
	...
	void rotateY()
	{
		rotY = new Matrix4f(	1, 0, 0, uVector,
								0, 1, 0, vVector,
								0, 0, 1, nVector,
								0, 0, 0, 1
							);
